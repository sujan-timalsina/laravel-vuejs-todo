                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            <input type="text" class="form-control" v-model="todo_input">
                            <div class="input-group-append">
                                <button v-if="!edit_todo_id" class="btn btn-success" @click="saveTodo()">Add</button>
                                <button v-else class="btn btn-success" @click="updateTodo()">Update</button>
                            </div>
                            <button @click="resetTodo()" class="btn btn-sm btn-warning float-end">Reset</button>
                        </div>
